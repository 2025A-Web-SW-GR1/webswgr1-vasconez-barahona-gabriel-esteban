...
let undefinedTs = undefined;
console.log(typeof undefineds, "undefined");
// Truty y Falsy
let func = function (trutyFalsy) {
    if (trutyFalsy) {
        console.log("Truty");
    }
    else {
...
const respuestaFindIndex = arreglo
    .findIndex(function (valorActual) {
    return valorActual.nota < 5; // Expresion (< =)
});
...
const respuestaReduce = arreglo
    .reduce(function (valorAcumulado, valorActual, indice, arreglo) {
...
function soloNumerosTs(a, b, c) {
    return a - b + c;
}
// Funciones que no retornan nada
function soloImprimir1(texto) {
    console.log(texto);
}
function soloImprimir2(texto) {
    console.log(texto);
}
// FUNCION NOMBRADA
...
function sumarNumeros(...muchosNumeros) {
    let total = 0;
...
const obj1Obj2Dest = Object.assign(Object.assign({}, objeto1), objeto2);
// Resultado: {"Mariela", "Morales"}
const overrideDest = Object.assign(Object.assign({}, obj1Obj2Dest), { nombre: "Normi" });
